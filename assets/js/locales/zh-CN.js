const zhCN = {
  meta: {
    description: "Filemeto — AI 驱动的 storyboard 分镜软件。把剧本快速转为镜头语言、分镜画布与可交付的镜头表。",
  ...
  hero: {
    ...
    description: "Filemeto 通过 AI 帮你从剧本/大纲自动生成分镜建议，并在画布中快速组织镜头序列、备注、评审与导出，适用于短片、广告、动画与内容创作流程。",
    actions: {
      download: "Download",
      github: "Github",
      contact: "Contact"
    ...
    cards: [
      {
        ...
        path: "占位路径：`./downloads/Filemeto-mac.dmg`",
        button: "下载 DMG（占位）",
        version: "macOS 12+"
      },
      {
        ...
        path: "占位路径：`./downloads/Filemeto-win.exe`",
        button: "下载 EXE（占位）",
        version: "Windows 10+"
      },
      {
        ...
        path: "占位路径：`./downloads/Filemeto-linux.AppImage`",
